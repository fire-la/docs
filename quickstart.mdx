...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0', margin: '2rem auto', maxWidth: '50%' }}>
  <div style={{ border: '1px solid #e5e7eb', borderRadius: '12px', padding: '1.25rem 1.5rem', width: '100%', textAlign: 'center', background: '#fffaf6' }}>
  ...
  <div style={{ border: '1px solid #e5e7eb', borderRadius: '12px', padding: '1.25rem 1.5rem', width: '100%', textAlign: 'center', background: '#fcfcfd' }}>
